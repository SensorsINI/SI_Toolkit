...
norm_infos = ["./SI_Toolkit/NormalizationInfo/" + "Dataset-1-norm.csv"] * len(
    tests
)  # Norm info for each test, for Euler has no effect, can be None or whatever
dt_euler = [0.002] * len(
    tests
...
def args():
    ...
    parser.add_argument(
        "--tests", default=tests, help="List of tests whcih should be performed"
    )
    parser.add_argument(
        "--norm_infos", default=norm_infos, help="List of norm_infos for neural nets"
    )
    parser.add_argument(
        "--dt_euler",
        default=dt_euler,
    ...
    parser.add_argument("--titles", default=titles, help="List of titles of tests.")
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="Indicates from which point data from test file should be taken.",
    )
    parser.add_argument(
        "--test_max_horizon",
        default=20,
